...
// or 8oo-six427676;laskdjf. Your job is to validate or reject the US phone number based on any combination 
// of the formats provided above. 
...
function telephoneCheck(str){
    ...
    const usPhoneRegex = /^1? ?(\(\d{3}\) ?|\d{3}[ -]?)\d{3}[ -]?\d{4}$/
